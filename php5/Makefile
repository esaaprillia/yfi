...
PKG_MD5SUM:=9469e240cbe6ac865aeaec89b253dd30
...
PHP5_MODULES = \
	...
	session shmop simplexml snmp soap sockets sqlite sqlite3 sysvmsg sysvsem sysvshm \
	tokenizer \
...
ifneq ($(SDK)$(CONFIG_PACKAGE_php5-mod-openssl),)$(CONFIG_PACKAGE_php5-mod-snmp),)
  CONFIGURE_ARGS+= \
